...
namespace DuAn1_Nhom6
{
    public partial class hoadon : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("select c.MaSanPham, d.IDVoucher, c.TenSanPham, d.MenhGia, d.HanSuDung, f.SoLuong, f.Gia from SanPham c join Voucher d on c.IDVoucher = d.IDVoucher join ChiTietSanPham f on c.MaSanPham = f.MaSanPham WHERE c.MaSanPham = @MaSanPham", conn))
            ...
            {
                cmd.Parameters.AddWithValue("@MaSanPham", maSanPhamTimKiem);
