...
namespace DuAn1_Nhom6
{
    public partial class Quanlysanpham : Form
    {
        ...
        void Xoa()
        {
            SqlCommand cmd1 = new SqlCommand("DELETE ChiTietSanPham WHERE MaCTSanPham = @MaCTSanPham", conn);
            SqlCommand cmd2 = new SqlCommand("DELETE SanPham WHERE MaSanPham = @MaSanPham", conn);
            cmd1.Parameters.AddWithValue("@MaCTSanPham", txtSPCT.Text);
        ...
        void Xoa2()
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM SanPham a join ChiTietSanPham b on a.MaSanPham = b.MaSanPham", conn);
        ...
        private void dgvSP_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvSP.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                ...
                txtSPCT.Text = dgvSP.Rows[e.RowIndex].Cells[4].Value.ToString();
        ...
        void LayDL()
        {
            string sql = "SELECT * FROM SanPham a join ChiTietSanPham b on a.MaSanPham = b.MaSanPham";
